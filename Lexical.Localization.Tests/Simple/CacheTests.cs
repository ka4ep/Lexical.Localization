...
namespace Lexical.Localization.Tests
{
    ...
    public class CacheTests
    {
        ...
        public void Test1()
        {
            ...
            IAsset map = new LocalizationDictionary(languageStrings, "{culture:}[type:]{section_0:}{section_1:}{section_2:}{section_n:}{key}");
        ...
        public void Test2()
        {
            ...
            IAsset map = new LocalizationDictionary(languageStrings, AssetKeyNameProvider.Default);

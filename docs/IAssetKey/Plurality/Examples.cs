...
namespace docs
{
    public class Plurality_Examples
    {
        public static void Main(string[] args)
        {
            {
                #region Snippet_0a
                IAsset asset = XmlLinesReader.Resolving.FileAsset("PluralityExample0a.xml");
            ...
            {
                #region Snippet_1a
                IAsset asset = XmlLinesReader.Resolving.FileAsset("PluralityExample0b.xml");
...

            {
                // Plurality permutations for argument 0
                #region Snippet_3
                IAsset asset = XmlLinesReader.Resolving.FileAsset("PluralityExample1.xml");
            ...
            }
            {
                ...
                #region Snippet_4
                IAsset asset = XmlLinesReader.Resolving.FileAsset("PluralityExample2.xml");
                ILine key = new LineRoot(asset).Key("CatsDogs");
            ...
            }
            {
                ...
                #region Snippet_5
                IAsset asset = XmlLinesReader.Resolving.FileAsset("PluralityExample2-en.xml");
                ILineRoot root = new LineRoot(asset);
            ...
            }
            {
                ...
                #region Snippet_6
                IAsset asset = XmlLinesReader.Resolving.FileAsset("PluralityExample4.xml");

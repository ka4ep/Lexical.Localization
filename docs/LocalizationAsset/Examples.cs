        ...
        public static void Main(string[] args)
        {
...

            {
                ...
                var source = new Dictionary<ILine, string> {
                    { ParameterParser.Instance.Parse("Type:MyController:Key:hello", Key.Root),            "Hello World!" },
                    { ParameterParser.Instance.Parse("Culture:en:Type:MyController:Key:hello", Key.Root), "Hello World!" },
                    { ParameterParser.Instance.Parse("Culture:de:Type:MyController:Key:hello", Key.Root), "Hallo Welt!"  }
                };
                // Create asset with string source

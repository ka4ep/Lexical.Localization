...
<tbody>
    ...
    <tr>
      <td><a href="https://github.com/tagcode/Lexical.Localization/blob/master/Lexical.Localization/LocalizationAsset/LocalizationDictionary.cs">LocalizationDictionary</a></td>

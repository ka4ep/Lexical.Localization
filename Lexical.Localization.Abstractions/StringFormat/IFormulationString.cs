...
namespace Lexical.Localization
{
    ...
    public interface IFormulationString
    {
        ...
        /// 
        /// The formatter is requested for following interfaces (Depends on <see cref="ILineStringResolver"/> implementation.)
        /// <list type="bullet">
        /// <item><see cref="IArgumentFormatter"/></item>
        /// <item><see cref="ICustomFormatter"/></item>
        /// </list>
        /// 
        /// <see cref="ILineStringResolver"/> combines format providers from asset and key.
    ...
    public class FormulationStringComparer : IEqualityComparer<IFormulationString>, IComparer<IFormulationString>
    {
        ...
        public int GetHashCode(IFormulationString o)
        {
            ...
            // Hash Status
            result ^= (int) ((ulong)(o.Status & LineStatus.FormulationMask) >> Shift.Formulation);
            result *= FNVHashPrime;

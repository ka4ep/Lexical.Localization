...
namespace Lexical.Localization
{
    ...
    /// Key (may have) has "Culture" parameter assigned.
    /// </summary>
    public interface ILineCultureKey : ILineCulture, ILineKeyNonCanonicallyCompared
    {
    }
    ...
    public static partial class ILinePartExtensions
    {
        ...
        public static CultureInfo GetCultureInfo(this ILine line)
        {
            ...
            if (line is ILineKeyNonCanonicallyComparedEnumerable enumr)
            ...
            if (line is ILinePart part)
            {
                ...
                for (ILinePart p = part; p != null; p = p.PreviousPart)
                {
                    ...
                    else if (p is ILineKey parameterKey && parameterKey.ParameterName == "Culture" && parameterKey.ParameterValue != null) cultureName = parameterKey.ParameterValue;
                }
        ...
        public static string GetCulture(this ILine line)
        {
            ...
            if (line is ILinePart part)
            {
                ...
                for (ILinePart p = part; p != null; p = p.PreviousPart)
                {
                    ...
                    else if (p is ILineKey parameterKey && parameterKey.ParameterName == "Culture" && parameterKey.ParameterValue != null) result = parameterKey.ParameterValue;
                }
        ...
        /// <summary>
        /// Search linked list and find the effective culture key either <see cref="ILineKey"/> or <see cref="ILineParameterPart"/>.
        /// </summary>
        /// <param name="line"></param>
        /// <returns>culture policy or null</returns>
        public static ILinePart GetCultureKey(this ILinePart line)
        {
            ILinePart result = null;
            for (; line != null; line = line.PreviousPart)
            {
                if (line is ILineCultureKey cultureKey && cultureKey.GetParameterValue() != null) result = cultureKey;
                else if (line is ILineParameterPart parameterKey && parameterKey.ParameterName == "Culture" && parameterKey.ParameterValue != null) result = parameterKey;
            }
            return result;
        }

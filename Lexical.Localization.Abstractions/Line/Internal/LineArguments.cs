...
namespace Lexical.Localization.Internal
{
    ...
    public class LineArgument<Intf> : LineArgument, ILineArgument<Intf>
    {
    }
    ...
    public class LineArgument<Intf, A0> : LineArgument, ILineArgument<Intf, A0>
    {
        /// <summary>
    ...
    public class LineArgument<Intf, A0, A1> : LineArgument, ILineArgument<Intf, A0, A1>
    {
        /// <summary>
        /// Value of first argument.
        /// </summary>
        ...
        /// <param name="a0"></param>
        /// <param name="a1"></param>
        public LineArgument(A0 a0, A1 a1)
        {
            this.Argument0 = a0;
            this.Argument1 = a1;
        }
    ...
    public class LineArgument<Intf, A0, A1, A2> : LineArgument, ILineArgument<Intf, A0, A1, A2>
    {
        /// <summary>
        /// Value of first argument.
        /// </summary>
        ...
        /// <param name="a1"></param>
        /// <param name="a2"></param>
        public LineArgument(A0 a0, A1 a1, A2 a2)
        {
            this.Argument0 = a0;
            this.Argument1 = a1;
            this.Argument2 = a2;

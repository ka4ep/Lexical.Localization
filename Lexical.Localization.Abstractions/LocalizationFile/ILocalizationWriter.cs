...
namespace Lexical.Localization
{
    ...
    public interface ILocalizationStringLinesTextWriter : ILocalizationWriter
    {
        ...
        void WriteStringLines(IEnumerable<KeyValuePair<string, IFormulationString>> lines, TextReader srcText, TextWriter dstText, IParameterPolicy namePolicy, LocalizationFileWriteFlags flags);
    }
    ...
    public interface ILocalizationStringLinesStreamWriter : ILocalizationWriter
    {
        ...
        /// <param name="flags"></param>
        /// <exception cref="IOException"></exception>
        void WriteStringLines(IEnumerable<KeyValuePair<string, IFormulationString>> lines, Stream srcStream, Stream dstStream, IParameterPolicy namePolicy, LocalizationFileWriteFlags flags);
    }

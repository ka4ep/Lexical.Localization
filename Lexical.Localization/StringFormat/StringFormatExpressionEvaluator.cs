...
namespace Lexical.Localization.StringFormat
{
    ...
    /// </summary>
    public struct StringFormatExpressionEvaluator
    {
        /// <summary>
        /// Format Arguments
        /// </summary>
        ...
        public StringFormatExpressionEvaluator(object[] args)
        {
            Args = args ?? throw new ArgumentNullException(nameof(args));
        }

        /// <summary>
        /// Evaluate expression into object (typically string).
        /// </summary>
        ...
        public object Evaluate(IExpression exp)
            ...
            if (exp is IUnaryOpExpression uop)
            {
                switch(uop.Op)
                {

...
namespace Lexical.Localization
{
    ...
    public static partial class LocalizationReaderExtensions_
    {
        ...
        /// <exception cref="FileNotFoundException">thrown if file was not found and <paramref name="throwIfNotFound"/> is true</exception>
        /// <exception cref="IOException">on io error</exception>
        public static IEnumerable<KeyValuePair<ILinePart, IFormulationString>> ReadKeyLines(this ILocalizationFileFormat fileFormat, string srcFilename, IAssetKeyNamePolicy namePolicy = default, bool throwIfNotFound = true)
        {
        ...
        public static IEnumerable<KeyValuePair<ILinePart, IFormulationString>> ReadKeyLines(this IReadOnlyDictionary<string, ILocalizationFileFormat> fileFormatProvider, string filename, IAssetKeyNamePolicy namePolicy = default, bool throwIfNotFound = true)

...
namespace Lexical.Localization
{
    ...
    public static partial class LocalizationReaderExtensions_
    {
        ...
        public static IEnumerable<KeyValuePair<string, IFormulationString>> ReadStringLines(this ILocalizationFileFormat fileFormat, string srcFilename, IAssetKeyNamePolicy namePolicy = default, bool throwIfNotFound = true)
        {
        ...
        /// <exception cref="FileNotFoundException">thrown if file was not found and <paramref name="throwIfNotFound"/> is true</exception>
        /// <exception cref="IOException">on io error</exception>
        public static IEnumerable<KeyValuePair<IAssetKey, IFormulationString>> ReadKeyLines(this ILocalizationFileFormat fileFormat, string srcFilename, IAssetKeyNamePolicy namePolicy = default, bool throwIfNotFound = true)
        {
        ...
        public static IEnumerable<KeyValuePair<IAssetKey, IFormulationString>> ReadKeyLines(this IReadOnlyDictionary<string, ILocalizationFileFormat> fileFormatProvider, string filename, IAssetKeyNamePolicy namePolicy = default, bool throwIfNotFound = true)
        ...
        /// <returns>lines</returns>
        /// <exception cref="KeyNotFoundException">If file format was not found in <paramref name="fileFormatProvider"/></exception>
        public static IEnumerable<KeyValuePair<string, IFormulationString>> ReadStringLines(this IReadOnlyDictionary<string, ILocalizationFileFormat> fileFormatProvider, string filename, IAssetKeyNamePolicy namePolicy = default, bool throwIfNotFound = true)
        ...
        static KeyValuePair<IAssetKey, IFormulationString>[] no_keylines = new KeyValuePair<IAssetKey, IFormulationString>[0];

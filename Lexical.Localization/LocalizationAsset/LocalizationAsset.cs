...
namespace Lexical.Localization
{
        ...
        IAssetObservable
    {
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual Dictionary<ILine, IFormulationString> KeyLines => keyLines ?? LoadKeyLines();
        ...
        /// </summary>
        protected virtual Dictionary<ILinePrinter, Dictionary<string, IFormulationString>> StringLinesByProvider => stringLinesByProvider ?? LoadStringLinesByProvider();

        /// <summary>
        /// Loaded and active key lines. It is compiled union of all sources.
        /// </summary>
        protected Dictionary<ILine, IFormulationString> keyLines;
        ...
        /// String lines sorted by name policy.
        /// </summary>
        protected Dictionary<ILinePrinter, Dictionary<string, IFormulationString>> stringLinesByProvider;
        ...
        protected virtual Dictionary<ILine, IFormulationString> LoadKeyLines()
        {
            Dictionary<ILine, IFormulationString> newLines = new Dictionary<ILine, IFormulationString>(comparer);
        ...
        /// <returns>new key lines</returns>
        /// <exception cref="Exception">If load fails</exception>
        protected virtual Dictionary<ILinePrinter, Dictionary<string, IFormulationString>> LoadStringLinesByProvider()
        {
            Dictionary<ILinePrinter, Dictionary<string, IFormulationString>> byProvider = new Dictionary<ILinePrinter, Dictionary<string, IFormulationString>>();
        ...
        public virtual IFormulationString GetString(ILine key)
        {
        ...
        public IEnumerable<KeyValuePair<ILine, IFormulationString>> GetKeyLines(ILine filterKey = null)
        {
            // Get snapshot
            var _lines = KeyLines;
            // Return all
        ...
        /// <param name="filterKey">(optional) filter key</param>
        /// <returns>list of key-lines, or null if could not be provided</returns>
        public IEnumerable<KeyValuePair<ILine, IFormulationString>> GetAllKeyLines(ILine filterKey = null)
        ...
        /// <param name="filterKey">(optional) filter key</param>
        /// <returns>lines or null</returns>
        public IEnumerable<KeyValuePair<string, IFormulationString>> GetAllStringLines(ILine filterKey = null)
        {
            // Return all 
            if (filterKey == null) return StringLines;
            // Create filter.
    ...
    /// Collection of lines
    /// </summary>
    public class Collection : IObserver<IAssetSourceEvent>, IEnumerable<KeyValuePair<ILine, IFormulationString>>, IEnumerable<KeyValuePair<string, IFormulationString>>
    {
        /// <summary>
        ...
        /// </summary>
        internal protected KeyValuePair<ILine, IFormulationString>[] keyLines;
        ...
        public KeyValuePair<ILine, IFormulationString>[] KeyLines
        {
            get
            {
                // Return snapshot
                ...
                try
                {
                    List<KeyValuePair<ILine, IFormulationString>> lines = new List<KeyValuePair<ILine, IFormulationString>>(lineCount < 0 ? 25 : lineCount);

                    // Read as key-lines
                    if (reader is IEnumerable<KeyValuePair<ILine, IFormulationString>> keyLinesReader)
                    {
                ...
                catch (Exception e) when (errorHandler != null && errorHandler(e))
                {
                    ...
                    return keyLines = new KeyValuePair<ILine, IFormulationString>[0];
                }
            }
        }
        ...
        public KeyValuePair<string, IFormulationString>[] StringLines
        {
            get
            {
                ...
                try
                {
                    ...
                    // Read as string lines
                    else if (reader is IEnumerable<KeyValuePair<ILine, IFormulationString>> keyLinesReader)
                    {
                        // Convert from string lines
        ...
        IEnumerator<KeyValuePair<ILine, IFormulationString>> IEnumerable<KeyValuePair<ILine, IFormulationString>>.GetEnumerator()
            => ((IEnumerable<KeyValuePair<ILine, IFormulationString>>)KeyLines).GetEnumerator();
    ...
    public static partial class LocalizationAssetExtensions_
    {
        ...
        /// <returns></returns>
        public static IAssetBuilder AddKeyLines(this IAssetBuilder builder, IEnumerable<KeyValuePair<ILine, IFormulationString>> lines)
        {
        ...
        /// <param name="lines"></param>
        /// <returns></returns>
        public static IAssetComposition AddKeyLines(this IAssetComposition composition, IEnumerable<KeyValuePair<ILine, IFormulationString>> lines)
        {

...
namespace Lexical.Localization
{
        ...
        IAssetResourceProvider
    {
        ...
        public readonly ILineFormatPolicy namePolicy;
        ...
        /// </summary>
        public  static readonly ILineFormatPolicy namepolicy_for_type_resourcemanager = new KeyPrinter().Rule("Section", true, ".").Rule("Key", true, ".").DefaultRule(false);
        ...
        /// Example "ConsoleApp1.MyController.Success"
        /// </summary>
        public static readonly ILineFormatPolicy namepolicy_for_location_resourcemanager = new KeyPrinter().Rule("Type", true, ".").Rule("Section", true, ".").Rule("Key", true, ".").DefaultRule(false);
        ...
        /// Example "ConsoleApp1.MyController.Success"
        /// </summary>
        public static readonly ILineFormatPolicy namepolicy_for_root_resourcemanager = new KeyPrinter().Rule("Resource", true, ".").Rule("Type", true, ".").Rule("Section", true, ".").Rule("Key", true, ".").DefaultRule(false);
        ...
        public ResourceManagerAsset(ResourceManager resourceManager, ILineFormatPolicy namePolicy, IStringFormatParser parser = default)
        {

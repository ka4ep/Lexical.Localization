...
namespace Lexical.Localization
{
    ...
    public static partial class LineReaderExtensions
    {
        ...
        public static LineEmbeddedKeyLinesSource EmbeddedReader(this ILineFileFormat fileFormat, Assembly asm, string resourceName, ILineFormat lineFormat = default, bool throwIfNotFound = true)
            => new LineEmbeddedKeyLinesSource(fileFormat, asm, resourceName, lineFormat, throwIfNotFound);
        ...
        public static LineEmbeddedLineTreeSource EmbeddedReaderAsLineTree(this ILineFileFormat fileFormat, Assembly asm, string resourceName, ILineFormat lineFormat = default, bool throwIfNotFound = true)
            => new LineEmbeddedLineTreeSource(fileFormat, asm, resourceName, lineFormat, throwIfNotFound);
        ...
        /// <param name="throwIfNotFound">if file is not found and value is true, <see cref="FileNotFoundException"/> is thrown, otherwise zero elements are returned</param>
        /// <returns>lines</returns>
        public static LineEmbeddedStringLinesSource EmbeddedReaderAsStringLines(this ILineFileFormat fileFormat, Assembly asm, string resourceName, ILineFormat lineFormat = default, bool throwIfNotFound = true)
            => new LineEmbeddedStringLinesSource(fileFormat, asm, resourceName, lineFormat, throwIfNotFound);
        ...
        /// <returns>reloadable localization asset</returns>
        /// <exception cref="System.Collections.Generic.KeyNotFoundException">If file format was not found in <paramref name="fileFormatProvider"/></exception>
        public static IAsset EmbeddedAsset(this IReadOnlyDictionary<string, ILineFileFormat> fileFormatProvider, Assembly asm, string resourceName, ILineFormat lineFormat = default, bool throwIfNotFound = true)
            => fileFormatProvider[LineFileFormatMap.GetExtension(resourceName)].EmbeddedAsset(asm, resourceName, lineFormat, throwIfNotFound);
        ...
        /// <returns>asset source</returns>
        /// <exception cref="System.Collections.Generic.KeyNotFoundException">If file format was not found in <paramref name="fileFormatProvider"/></exception>
        public static LineEmbeddedSource EmbeddedAssetSource(this IReadOnlyDictionary<string, ILineFileFormat> fileFormatProvider, Assembly asm, string resourceName, ILineFormat lineFormat = default, bool throwIfNotFound = true)
            => fileFormatProvider[LineFileFormatMap.GetExtension(resourceName)].EmbeddedAssetSource(asm, resourceName, lineFormat, throwIfNotFound);

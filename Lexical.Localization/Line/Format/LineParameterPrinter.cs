...
namespace Lexical.Localization
{
    ...
    public class LineParameterPrinter : ILinePrinter, ICloneable
    {
        ...
        /// <returns>this</returns>
        public LineParameterPrinter ParameterInfo(IParameterInfo info, string prefixSeparator = null, string postfixSeparator = null)
        {
        ...
        /// <param name="postfixSeparator"></param>
        /// <returns>this</returns>
        public LineParameterPrinter ParameterInfo(IEnumerable<IParameterInfo> infos, string prefixSeparator = null, string postfixSeparator = null)
        {
        ...
        /// <param name="order"></param>
        /// <returns>this</returns>
        public LineParameterPrinter CanonicalRule(bool isIncluded, string prefixSeparator = null, string postfixSeparator = null, int order = 0)
        {
        ...
        public object Clone()
        {
            LineParameterPrinter result = new LineParameterPrinter();
    ...
    public static partial class LineExtensions
    {
        ...
        {
            if (policy == null) policy = LineParameterPrinter.Default;
        ...
        public static string Print(this ILine key)
            => LineParameterPrinter.Default.Print(key);
